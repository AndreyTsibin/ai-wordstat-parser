...
> 💡 **Для нового пользователя:** Откройте [START.md](START.md) — там готовый промпт для быстрого запуска через Claude Code.
...
**Для работы с Claude Code:** Просто скажите "Запусти workflow.py" — AI всё сделает сам!
...
├── START.md              # 🚀 Готовый промпт для быстрого запуска
